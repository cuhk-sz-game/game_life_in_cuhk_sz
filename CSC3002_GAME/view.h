...
public:
    ...
    void keyPhone(QKeyEvent *event); // like a menu
    void keyWelcome(QKeyEvent *event);
    void keySelect(QKeyEvent *event);
    void keyLike(); //Find girlfriend/boyfriend sucessfully
    ...
    void keyEatTogether(QKeyEvent *event); //eat together with gf/bf
